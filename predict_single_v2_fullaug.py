...
def process_single_image(image_path, output_dir):
    ...
    :return: Tuple of (star_features, heatmap).
    """
    # Load the image
    ...
    # Generate heatmap
    heatmap = create_star_heatmap((256, 256), star_positions, image_size, sigma=5)
...
# Inference function
def infer_single_image(model, image, heatmap, star_features, transform, device):
    """
    ...
    image, heatmap, star_features = preprocess_input(image, heatmap, star_features, transform)
...
if __name__ == "__main__":
    # Define paths
    checkpoint_path = "/media/student/B076126976123098/my_data/SiT/model_swin7_aug/swin_epoch_45.pth"
    image_path = "/media/student/B076126976123098/my_data/SiT/dataset_sky/sky_with_angles7_guassian_global_centroided_processed_with_red_centroid_grs_avoided_centroid_rotated_folder/N110/N110_1.png"
    output_dir = "/media/student/B076126976123098/my_data/SiT/test_output"
    
    # Process the single image
    star_features, heatmap,image = process_single_image(image_path, output_dir)
